        ...
        <table class="booking">
            <tbody>
                ...
                <tr>
                    ...
                    <td><input type="text"  id="txt_fname" name="tx_fname" placeholder="First Name" value="${user.fName}"/></td></td>
                    <td><label>Last Name</label></td>
                    <td><input type="text"  id="txt_lname" name="tx_lname" placeholder="Last Name" value="${user.lName}"/></td></td>
                </tr>
                <tr>
                    <td><label>Email Address</label></td>
                    <td><input type="text"  id="txt_email" name="tx_email" placeholder="Email Address" value="${user.email}"/></td></td>
